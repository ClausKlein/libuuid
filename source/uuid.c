...
/* format_uuid_v1 -- make a UUID from the timestamp, clockseq,
                     and node ID */
void format_uuid_v1(_uuid_t *uuid, uint16_t clock_seq, uuid_time_t timestamp,
                    uuid_node_t node) {
...
void uuid_create_md5_from_name(_uuid_t *uuid, _uuid_t nsid, void *name,
                               int namelen) {
    MD5_CTX c;
...
#ifdef USE_SHA1
void uuid_create_sha1_from_name(_uuid_t *uuid, _uuid_t nsid, void *name,
                                int namelen) {
    SHA_CTX c;
...
/* format_uuid_v3or5 -- make a UUID from a (pseudo)random 128-bit
   number */
void format_uuid_v3or5(_uuid_t *uuid, unsigned char hash[16], int v) {
